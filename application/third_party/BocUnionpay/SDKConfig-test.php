...
// 签名证书路径
define('SDK_SIGN_CERT_PATH',APPPATH.'third_party/BocUnionpay/cer/test/acp_test_sign.pfx');
// 签名证书密码
const SDK_SIGN_CERT_PWD = '000000';
// 密码加密证书（这条一般用不到的请随便配）
define('SDK_ENCRYPT_CERT_PATH',APPPATH.'third_party/BocUnionpay/cer/test/acp_test_enc.cer');
// 验签证书路径（请配到文件夹，不要配到具体文件）
define('SDK_VERIFY_CERT_DIR',APPPATH.'third_party/BocUnionpay/cer/test/');
// 前台请求地址
...
#const SDK_FRONT_TRANS_URL = 'https://116.246.38.72:5000/gateway/api/frontTransReq.do';
...
#const SDK_BACK_TRANS_URL = 'https://116.246.38.72:5000/gateway/api/backTransReq.do';
// 批量交易
...
#const SDK_SINGLE_QUERY_URL = 'https://116.246.38.72:5000/gateway/api/queryTrans.do';
//文件传输请求地址
